...
//		System.out.println("myModuleName= "+myModuleName);
	...
	public final void setPartialDocument()
	{
        ...
        {
            case 2:text = text.segmentPartialTextData[0];
                break;
                
            case 3:text = text.segmentPartialTextData[1];
                break;
                
            case 4:text = text.sentencePartialTextData[0];
                break;
                
            case 5:text = text.sentencePartialTextData[1];
                break;
        }
	}
