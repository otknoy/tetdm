...
//		resetAll_for_stealth(tex);
    ...
    switch (mining[selected_module].partialDocumentA) {
      case 2:
        mining[selected_module].combinationPanel.panelSetFocusSegments(0);
        break;

      case 3:
        mining[selected_module].combinationPanel.panelSetFocusSegments(1);
        break;

      case 4:
        mining[selected_module].combinationPanel.panelSetFocusSentences(0);
        break;

      case 5:
        mining[selected_module].combinationPanel.panelSetFocusSentences(1);
        break;
    }
