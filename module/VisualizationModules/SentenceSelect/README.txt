フォーカス文を選択できるチェックボックスを表示
文選択(SegmentSelect(ID=1101))

チェックボックスにより，フォーカスをあてる文の集合を明示的に選択できます．
チェックボックスがチェックされると，
選択された文がフォーカス文として情報が上書きされます．

「部分-3にセット」ボタンで，フォーカス文からなる部分テキストデータを作成し，「部分-3」に保存します．
「部分-4にセット」ボタンで，フォーカス文からなる部分テキストデータを作成し，「部分-4」に保存します．
...
text.focus.sentences[] の値を true/false にセットします
