	...
	public void itemStateChanged(ItemEvent e)
	{
		...
		for(int i=0;i<setBoxA.length;i++)
			if(e.getSource() == setBoxA[i])
			{
				switch(i)
				{
                    case 0: settingData.morpheme = "Igo";
                        changeMorpheme();
                        break;
                        
                    case 1: settingData.morpheme = "ChaSen";
                        changeMorpheme();
                        break;
                    ...
                    case 6: if(setBoxA[6].isSelected())
                                settingData.defaultCode = "SJIS";
                        break;
                    case 7: if(setBoxA[7].isSelected())
		...
		for(int i=0;i<setBoxB.length;i++)
			if(e.getSource() == setBoxB[i])
			{
				switch(i)
				{
                  case 0: settingData.excludeHiragana = setBoxB[0].isSelected();
                        break;
                  case 1: settingData.excludeKatakana = setBoxB[1].isSelected();
                        break;
                  case 2: settingData.excludeOne = setBoxB[2].isSelected();
                        break;
                  case 3: settingData.excludeHankaku = setBoxB[3].isSelected();
                        break;
                  case 4: settingData.inJapanese = setBoxB[4].isSelected();
