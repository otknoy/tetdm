...
//		System.out.println("myModuleName= "+myModuleName);		
    ...
    {
        if(booleanNumber < dataNumbers[0]) return false;
        if(integerNumber < dataNumbers[1]) return false;
        if(doubleNumber < dataNumbers[2]) return false;
        if(StringNumber < dataNumbers[3]) return false;
        if(booleanArrayNumber < dataNumbers[4]) return false;
        if(integerArrayNumber < dataNumbers[5]) return false;
        if(doubleArrayNumber < dataNumbers[6]) return false;
        if(StringArrayNumber < dataNumbers[7]) return false;
        if(booleanArray2Number < dataNumbers[8]) return false;
        if(integerArray2Number < dataNumbers[9]) return false;
        if(doubleArray2Number < dataNumbers[10]) return false;
	...
	public boolean dataConstraint(){return true;}
	...
	public boolean setData(int dataID, boolean data){return false;}
	public boolean setData(int dataID, int data){return false;}
	public boolean setData(int dataID, double data){return false;}
	public boolean setData(int dataID, String data){return false;}
	public boolean setData(int dataID, boolean data[]){return false;}
	public boolean setData(int dataID, int data[]){return false;}
	public boolean setData(int dataID, double data[]){return false;}
	public boolean setData(int dataID, String data[]){return false;}	
	...
	final public boolean setData(boolean data){return false;}
	final public boolean setData(int data){return false;}
	final public boolean setData(double data){return false;}
	final public boolean setData(String data){return false;}
	final public boolean setData(boolean data[]){return false;}
	final public boolean setData(int data[]){return false;}
	final public boolean setData(double data[]){return false;}
	final public boolean setData(String data[]){return false;}
